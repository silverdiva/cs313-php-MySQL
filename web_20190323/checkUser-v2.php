...
if(password_verify($_POST['password'], $result[0]['password']) ) 
{
    ...
    header("Location: readytoShop.php");
...
else if (!isset($_SESSION['userAuthorized']))
{
	echo "<h1> Login information does not match our records. Please check your username and password and try again.</h1>";
	header("Location: loginShopping-v4.php");
}
